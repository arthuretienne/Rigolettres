<?php
/**
 * Migré depuis Code Snippet #38 : [Rigolettres] 25 — Quiz Aide au choix
 * Description : Quiz 3 questions (niveau/défi/contexte) → reco 1 match + 2 alternatives. Différenciateur CRO. FAB desktop bottom-left + mobile. Triggers: .rigo-quiz-trigger, href=#rigo-quiz.
 */
    ...
    <div class="rigo-quiz-modal" id="rigo-quiz" role="dialog" aria-modal="true" aria-labelledby="rigo-quiz-title" hidden>
        ...
        <div class="rigo-quiz-box" role="document">
            ...
            <div class="rigo-quiz-step rigo-quiz-result" data-step="4" id="rigo-quiz-result" hidden>
                ...
                <p class="rigo-quiz-sub">Sélection validée par Brigitte, orthophoniste à Mamers depuis 1978.</p>

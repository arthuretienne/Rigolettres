<?php
/**
 * Migré depuis Code Snippet #24 : [Rigolettres] 13 — Announcement bar close button + contrast fix
 * Description : Bouton ✕ pour fermer la barre d'annonce + fix contraste bouton vert WCAG AA
 */

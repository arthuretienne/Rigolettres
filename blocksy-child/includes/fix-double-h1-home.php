<?php
/**
 * Migré depuis Code Snippet #8 : [Rigolettres] Fix double H1 home
 * Description : Désactive hero/page-title Blocksy sur front page + CSS fallback. Source: audit.md Phase A.6
 */
